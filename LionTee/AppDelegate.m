...
//    [self.window makeKeyAndVisible];
    ...
    if (iOSScreenSize.height == 667) {
        UIStoryboard *iPhone6StoryBoard = [UIStoryboard storyboardWithName:@"Adaptive_Main_iphone6" bundle:nil];
...
//
    if (iOSScreenSize.height == 736) {
        ...
        UIStoryboard *iPhone6StoryBoard = [UIStoryboard storyboardWithName:@"Adaptive_Main_iphone6_plus" bundle:nil];

...
- (NSArray *)californiaShippingMethods {
    ...
    PKShippingMethod *normalItem =
        [PKShippingMethod summaryItemWithLabel:@"USPS 3-5 Business Days" amount:[NSDecimalNumber decimalNumberWithString:@"0.00f"]];
    normalItem.detail = @"3-5 Business Days";
    normalItem.identifier = normalItem.label;
//    PKShippingMethod *expressItem =
//        [PKShippingMethod summaryItemWithLabel:@"USPS Standard Mail" amount:[NSDecimalNumber decimalNumberWithString:@"0.00f"]];
